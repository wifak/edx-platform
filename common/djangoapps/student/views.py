...
from student.models import (
    ...
    DashboardConfiguration, LinkedInAddToProfileConfiguration, ManualEnrollmentAudit, ALLOWED_TO_ENROLL_TO_ENROLL)
                ...
                if cea.auto_enroll:
                    ...
                    if manual_enrollment_audit is not None:
                        ...
                        ManualEnrollmentAudit.create_manual_enrollment_audit(
                            manual_enrollment_audit.enrolled_by, student[0].email, ALLOWED_TO_ENROLL_TO_ENROLL,
