...
class CreditRequirement(TimeStampedModel):
    ...
    'location'.
    The 'location' field stores the location of XBlock as a requirement, which
    serves as the unique identifier for a credit course requirement.
    The 'name' field stores the display name of the requirement.
    ...
    class Meta(object):
        ...
        Model metadata.
        """
        unique_together = ('namespace', 'location', 'course')
